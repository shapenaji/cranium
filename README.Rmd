...
```{r Setup, message=FALSE, echo=TRUE, eval=FALSE}
library(cranium)
...
```{r InstallPackages, warning=FALSE, echo=TRUE, eval=FALSE, include=FALSE}
...
```{r InstallPackagesVis2, eval = FALSE}
set_repo_location(tempdir())
```

### Install from github:

```{r InstallPackagesVis3, eval = FALSE}
...
```{r InstallPackagesVis4, eval = FALSE}
install_package_to_repo(pkg = 'miniCRAN')
```

### Installing from git:

```{r InstallPackagesVis5, eval = FALSE}
install_package_to_repo('https://path/to/package.git')
```

### Installing a local package:

```{r InstallPackagesVis6, eval = FALSE}
...
```{r InstallPackagesVis7, echo=TRUE, eval=FALSE}
...
```{r InstallPackagesVis8, echo=TRUE, eval=FALSE}
...
```{r usingrepo, echo=TRUE, eval=FALSE, message=TRUE, warning=FALSE}
...
```{r addtooptions, echo=TRUE, eval=FALSE, message=TRUE, warning=FALSE}
...
```{r modifydescription, echo=TRUE, eval=FALSE, message=TRUE, warning=FALSE}
