...
```{r InstallPackagesVis7, eval = FALSE}
...
```{r InstallPackagesVis8, eval = FALSE}
...
```{r addtooptions, eval=FALSE, message=TRUE, warning=FALSE}
...
```{r modifydescriptions, eval=FALSE, message=TRUE, warning=FALSE}
